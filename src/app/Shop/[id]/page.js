...
export default function ProductPage() {
    ...
    if (loading) {
        return (
            <Box sx={{ minHeight: "100vh", bgcolor: alpha(theme.palette.grey[50], 0.9) }}>
                <Box sx={{ py: { xs: 4, md: 6 }, background: heroBg, borderBottom: "1px solid", borderColor: "divider" }}>
                    <Container>
                        <Stack spacing={1.2}>
                ...
                <Container sx={{ mt: { xs: 2.2, md: 3 }, pb: 10 }}>
                    <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1.15fr 0.85fr" }, gap: 2.2 }}>
                        <Paper sx={{ ...surface, overflow: "hidden" }}>
                            <Box sx={{ p: { xs: 2, md: 2.2 } }}>
                                <Skeleton variant="rounded" height={600} sx={{ borderRadius: 5 }} />
                            </Box>
                        </Paper>
