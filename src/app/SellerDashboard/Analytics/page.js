...
export async function generateMetadata() {
    try {
        ...
        return {
            title: `${storeName} Dashboard | Analytics `,
            description: `Manage your analytics in your ${storeName} dashboard. Track sales performance, monitor customer behavior, and make data-driven decisions to grow your business on our platform.`,
            icons: {
                icon: "/icons/AnalyticsPages.svg",
            }
        };
    } catch (error) {
