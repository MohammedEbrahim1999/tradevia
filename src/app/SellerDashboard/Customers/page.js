...
export async function generateMetadata() {
    try {
        ...
        return {
            title: `${storeName} Dashboard | Customers `,
            description: `Manage your customers in your ${storeName} dashboard. View customer details, track purchase history, and engage with your audience to grow your business on our platform.`,
            icons: {
