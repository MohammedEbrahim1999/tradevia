...
export async function generateMetadata() {
    try {
        ...
        return {
            title: `${storeName} Dashboard | Brands `,
            description: `Manage your brands in your ${storeName} dashboard. Add new brands, update existing ones, and attract more customers to grow your business on our platform.`,
            icons: {
