...
export async function generateMetadata() {
    try {
        ...
        return {
            title: `${storeName} Dashboard | Orders `,
            description: `Track and manage your orders in your ${storeName} dashboard. View order details, update order status, and ensure timely delivery to grow your business on our platform.`,
            icons: {
